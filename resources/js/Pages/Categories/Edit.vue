...
// Recebe a prop 'category' do backend
...
// Inicializa o formulário com os dados da categoria recebida
const form = useForm({
  name: props.category.name || "",
  description: props.category.description || "",
});

// Define o método submit para enviar os dados via put na rota de atualização
const submit = () => {
