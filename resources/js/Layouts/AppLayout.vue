...
<template>
  <div>
    ...
    <div class="min-h-screen bg-gray-100 dark:bg-gray-900">
                ...
                <Dropdown align="right" width="48" class="relative">
                  <template #trigger>
                    ...
                    <span v-else class="inline-flex rounded-md">
                      <button
                        type="button"
                        class="inline-flex items-center px-3 py-2 border border-transparent text-sm leading-4 font-medium rounded-md text-gray-500 bg-white hover:text-gray-700 focus:outline-none focus:bg-gray-50 active:bg-gray-50 transition ease-in-out duration-150 dark:bg-gray-800 dark:text-white"
                      >
      ...
      <!-- Page Heading -->
      <header v-if="$slots.header" class="bg-white shadow dark:bg-gray-900 dark:text-white dark:border-gray-800 dark:border-b">
